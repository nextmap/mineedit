...
import org.geotools.referencing.crs.{AbstractDerivedCRS, DefaultGeographicCRS}
...
object ShapeViewer {
  def main(args: Array[String]) {
    val store = FileDataStoreFinder.getDataStore(new File("/Volumes/MY-HD-1/gshhg/gshhg-shp-2.3.2/GSHHS_shp/l/GSHHS_l_L1.shp"))
    //          val store = FileDataStoreFinder.getDataStore(new File("/Volumes/MY-HD-1/gshhg/gshhg-shp-2.3.2/WDBII_shp/c/WDBII_river_c_L02.shp"))
    ...
    eckert.asInstanceOf[AbstractDerivedCRS].getConversionFromBase.asInstanceOf[DefaultProjection].getMathTransform
